(custom-set-variables
 ...
 '(default-frame-alist (quote ((foreground-color . "Black") (background-color . "White") (cursor-type . box) (cursor-color . "Red") (vertical-scroll-bars . right) (internal-border-width . 0) (left-fringe . 1) (right-fringe) (fringe) (tool-bar-lines . 0) (menu-bar-lines . 1))))
 '(js2-mirror-mode nil)
 '(menu-bar-mode t)
